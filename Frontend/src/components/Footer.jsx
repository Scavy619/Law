            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-14 lg:pt-16 pb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-x-10 md:gap-y-8 lg:gap-16">
                    ...
                    <div className="md:pr-4 lg:col-span-5">
                        <div className="mb-5 md:mb-6 cursor-pointer w-fit" onClick={handleClick}>
                            <Logo textClassName="text-2xl" iconClassName="w-9 h-9" />
                        </div>

                        <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-6 md:mb-8">
                            {lawyerProfile.shortBio}
                        </p>
                        <div className="flex space-x-4">
                            {/* WhatsApp */}
                            <a href={whatsappLink()} target="_blank" rel="noopener noreferrer" className="bg-[#25D366] p-2.5 md:p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-[#25D366]/50 group">
                            ...
                            {/* LinkedIn */}
                            <a href={site.social.linkedin} target="_blank" rel="noopener noreferrer" className="bg-blue-600 p-2.5 md:p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-blue-600/50 group">
                            ...
                            {/* Instagram */}
                            <a href={site.social.instagram} target="_blank" rel="noopener noreferrer" className="bg-gradient-to-tr from-amber-500 via-pink-600 to-purple-600 p-2.5 md:p-3 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-lg group">
                        ...
                        <div className="space-y-4 md:space-y-5 lg:space-y-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4 text-sm md:text-base text-gray-600">
                                    <a href={`tel:${site.phone}`} className="hover:text-blue-600 transition-colors duration-200">
                                        {site.phoneDisplay}
                                    </a>
                                </div>
                            </div>
                            <div className="flex items-center">
                                ...
                                <div className="ml-4 text-sm md:text-base text-gray-600">
                                    <a href={`mailto:${site.email}`} className="hover:text-red-600 transition-colors duration-200 break-all md:break-normal">
                                        {site.email}
                                    </a>
                                </div>
                            </div>
                ...
                <div className="mt-10 md:mt-12 pt-6 md:pt-8 border-t border-gray-200">
                    <p className="text-sm md:text-base text-gray-500 text-center">
                        &copy; {new Date().getFullYear()} {site.brandTitle}. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
