            ...
            <div className='relative z-10 w-full flex flex-col items-center justify-center gap-6 py-16 md:py-[10vw] text-center'>
                ...
                <div className='flex flex-col items-center gap-3 text-white/90 font-light max-w-2xl'>
                    <p className='text-base md:text-lg'>
                        No jargon, no judgment — just a clear, honest conversation with Adv. Shivam Parashar about whatever you're dealing with, at your own pace.
                    </p>
                </div>
                ...
                <div className='flex flex-wrap justify-center gap-2 max-w-2xl'>
                    {practiceAreas.map((area) => (
                        <span
                            key={area}
                            className='text-xs md:text-sm text-white/90 border border-white/25 rounded-full px-3 py-1'
                        >
                            {area}
                        </span>
                    ))}
                ...
                <div className='flex flex-col sm:flex-row items-center gap-3 mt-2'>
                    ...
                    <Link
                        to='/lawyers'
                        className='flex items-center gap-2 bg-white px-8 py-3.5 rounded-full text-[#595959] text-base md:text-lg font-medium hover:scale-105 transition-all duration-300'
                    >
                ...
                <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-5 mt-1 text-white/80 text-sm'>
                    <a href='tel:+919472761482' className='flex items-center gap-1.5 hover:text-white transition-colors'>
                        <Phone className='w-4 h-4' />
                        Or call +91 94727 61482
                    </a>
                    <span className='hidden sm:inline text-white/40'>·</span>
                    <Link
                        to='/chatbot'
                        className='flex items-center gap-1.5 hover:text-white underline underline-offset-4 transition-colors'
                    >
