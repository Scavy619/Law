      ...
      <div className="space-y-8 text-gray-700">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm md:text-base">
            <li>
              Provide accurate, updated, and complete information during
              registration
            </li>
            <li>Maintain the confidentiality of your account credentials</li>
            <li>
              Attend scheduled consultations or cancel them within the specified
              timeframe
            </li>
            <li>Treat legal professionals with respect and professionalism</li>
            <li>Pay applicable consultation or service fees</li>
            <li>
              Use the platform only for lawful purposes and comply with all
        ...
        <section>
          ...
          <p className="mb-4 text-sm md:text-base leading-relaxed">
            ...
            within any 5-day period (including the current day).
          </p>
          <p className="mb-4 text-sm md:text-base leading-relaxed">
            Cancellations must be made at least 24 hours prior to the scheduled
            time to avoid cancellation charges or penalties.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-4 text-sm md:text-base leading-relaxed">
            Payments for legal consultations or related services are due at the
            time of booking unless otherwise specified. We support multiple
            secure digital payment methods. Refunds, if applicable, will be
        ...
        <section>
          ...
          <p className="mb-4 text-sm md:text-base leading-relaxed">
            ...
            time for violations of these Terms and Conditions, misuse of the
            platform, or any activity deemed harmful to the platform or its
            users.
          </p>
        </section>
